...
def process_component(
    ...
    if (
        ...
        repo.git.mv(
            f"{os.path.join("Training-Darko-Mirchevski/Root/Parent/Child/", component_refs[component_info_id])}",
            f"{os.path.join("Training-Darko-Mirchevski/Root/Parent/Child/", component_file_name)}"
        )
